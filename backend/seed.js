...
const Faculty = require("./modules/faculty/model"); // Import Faculty Model
...
const seedDatabase = async () => {
  try {
    ...
    console.log("👨‍🏫 Creating Faculty users and profiles...");

    // Faculty 1: Dr. Rajesh Kumar
    // FIXED: Variable name is 'faculty1' (not faculty1User) so attendance logic works later
    ...
    // Faculty 2: Prof. Priya Sharma
    // FIXED: Variable name is 'faculty2'
    ...
    const studentsData = [
      ...
      },
      {
        ...
        guardianInfo: { fatherName: "Krishnan Nair", motherName: "Radha Nair" },
        status: "Active",
        createdBy: admin._id,
      },
    ];
    ...
    for (let day = 0; day < 30; day++) {
      ...
      for (const student of students) {
        ...
        const relevantSubjects =
          student.academicInfo.department === "Computer Science"
            ? subjects.slice(0, 4)
            : [subjects[4]];
    ...
    console.log("\n📊 Summary:");
    console.log(`   - Admin: 1`);
    console.log(`   - Faculty: 2 (Users + Profiles)`);
